...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const [shiftsResp, agentsResp, feedbackResp] = await Promise.all([
    ...
    return NextResponse.json({ success: true, data: { active_shifts, on_duty, en_route, idle, avg_response_time } });
  } catch (e) {
